...
Complete mobile authentication system for the Ibimina Staff Android app including:
...
### Purpose
Automatically capture MoMo SMS messages to extract payment references and allocate deposits to groups/members.
...
#### SmsReceiver.kt
- **Location**: `apps/admin/android/app/src/main/java/rw/ibimina/staff/plugins/SmsReceiver.kt`
...
#### SmsSyncWorker.kt
- **Location**: `apps/admin/android/app/src/main/java/rw/ibimina/staff/plugins/SmsSyncWorker.kt`
...
### Purpose
Allow staff to scan QR codes displayed on the web dashboard to authenticate using biometric authentication.
...
### Purpose
Allow staff to set up a 6-digit PIN for quick login after initial email/password authentication.

### Native Android Components

#### PinAuthPlugin.kt
- **Location**: `apps/admin/android/app/src/main/java/rw/ibimina/staff/plugins/PinAuthPlugin.kt`
- **Methods**:
...
#### PinStorageHelper.kt
- **Location**: `apps/admin/android/app/src/main/java/rw/ibimina/staff/plugins/auth/PinStorageHelper.kt`
...
### SMS Ingestion
- **POST `/api/sms/ingest`**
  - Body: `{ messages: Array<{ sender, body, timestamp, amount?, reference? }> }`
