...
values
  ('11111111-1111-1111-1111-111111111111', 'Kigali SACCO', 'Gasabo', '001', 'M001'),
  ('22222222-2222-2222-2222-222222222222', 'Musanze SACCO', 'Muhoza', '002', 'M002');

insert into app.ikimina (id, sacco_id, code, name)
values
  ('33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', 'IK-A', 'Kigali Growth'),
  ('44444444-4444-4444-4444-444444444444', '22222222-2222-2222-2222-222222222222', 'IK-B', 'Musanze Progress');

insert into app.members (id, ikimina_id, sacco_id, member_code, full_name, msisdn)
values
  ('55555555-5555-5555-5555-555555555555', '33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', 'M-A1', 'Aline Umuhoza', '250788000001'),
  ('66666666-6666-6666-6666-666666666666', '44444444-4444-4444-4444-444444444444', '22222222-2222-2222-2222-222222222222', 'M-B1', 'Beni Kamanzi', '250788000002');

insert into auth.users (id, email, raw_app_meta_data)
values
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'alice@sacco.rw', jsonb_build_object('role', 'SACCO_STAFF')),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'ben@sacco.rw', jsonb_build_object('role', 'SACCO_STAFF')),
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'admin@sacco.rw', jsonb_build_object('role', 'SYSTEM_ADMIN'));

update app.user_profiles
set sacco_id = '11111111-1111-1111-1111-111111111111', role = 'SACCO_STAFF'
where user_id = 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa';

update app.user_profiles
set sacco_id = '22222222-2222-2222-2222-222222222222', role = 'SACCO_STAFF'
...
values ('33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', 'M-A2', 'Chantal Iradukunda', '250788000010');
