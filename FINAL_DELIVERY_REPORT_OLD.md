...
**Location:** `supabase/migrations/*tapmomo*`, `supabase/functions/tapmomo-reconcile/`, `apps/staff-mobile-android/tapmomo/`
...
**Location:** `supabase/migrations/20251031080000_device_auth_system.sql`, `supabase/functions/generate-auth-qr/`, `apps/admin/`, `apps/staff-mobile-android/qr-auth/`
...
**Location:** `supabase/migrations/20260305000000_whatsapp_otp_auth.sql`, `supabase/functions/send-whatsapp-otp/`, `supabase/functions/verify-whatsapp-otp/`
...
- [x] Supabase Studio: https://supabase.com/dashboard/project/vacltfdslodqybxojytc
