...
This guide helps verify that PRs #270, #305, and #307 were merged successfully
...
const testDoc = {
  ...
  content:
    "To apply for a SACCO loan, members must have maintained regular savings for at least 6 months...",
  sourceType: "manual",
...
**Need help?** See
[PR_CONFLICT_RESOLUTION_GUIDE.md](./PR_CONFLICT_RESOLUTION_GUIDE.md) for
