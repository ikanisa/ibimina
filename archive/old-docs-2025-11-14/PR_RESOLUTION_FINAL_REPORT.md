...
Successfully resolved conflicts in **PR #589** and provided automated scripts
for resolving the remaining PRs.
...
- Conflicts: ✅ **RESOLVED**
- Mergeable: ✅ **YES**
- CI Checks: ⚠️ **FAILING** (expected - pre-existing issues, not related to
  conflict resolution)
