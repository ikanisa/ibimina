...
- ⚠️ **Deployment**: Edge Function live; database migration awaiting
...
- `20260303000000_apply_tapmomo_conditional.sql` - Conditional version for
  manual application
...
**Security Notice:**  
This system handles financial transactions. Ensure all security best practices
are followed:
