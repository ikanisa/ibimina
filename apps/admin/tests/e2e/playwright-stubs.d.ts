interface PlaywrightPage {
  ...
  getByRole: (...args: unknown[]) => { toBeVisible: () => Promise<void>; click: () => Promise<void>; fill: (value: string) => Promise<void>; };
  getByLabel: (...args: unknown[]) => { toBeVisible: () => Promise<void>; fill: (value: string) => Promise<void>; };
