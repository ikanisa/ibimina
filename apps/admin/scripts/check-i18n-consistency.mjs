...
const expectations = [
  ...
  { key: 'admin.queue.title', en: 'Notification queue', rw: "Urutonde rw'ubutumwa", fr: 'File de notifications' },
  ...
  { key: 'system.offlineQueue.title', en: 'Offline queue', rw: 'Urutonde rwo gufata', fr: 'File hors ligne' },
  { key: 'system.offlineQueue.status.pending', en: 'Queued', rw: 'Birategereje', fr: 'En file' },
  { key: 'system.offlineQueue.status.syncing', en: 'Syncing', rw: 'Birimo bihuzwa', fr: 'Synchronisation' },
  { key: 'system.offlineQueue.banner.offline', en: 'Offline', rw: 'Bitari ku murongo', fr: 'Hors ligne' },
  { key: 'system.offlineQueue.banner.queued', en: 'Queued', rw: 'Birategereje', fr: 'En file' },
  { key: 'system.offlineQueue.banner.needsRetry', en: 'Needs retry', rw: 'Bikeneye kongera kugeragezwa', fr: 'Relance nécessaire' },
  // Connectivity
  { key: 'common.online', en: 'Online', rw: 'Ku murongo', fr: 'En ligne' },
  { key: 'common.offline', en: 'Offline', rw: 'Bitari ku murongo', fr: 'Hors ligne' },
  // Recon filters
  { key: 'recon.filters.duplicatesOnly', en: 'Duplicates only', rw: 'Byisubiyemo gusa', fr: 'Doublons seulement' },
  { key: 'recon.filters.lowConfidence', en: 'Low confidence', rw: 'Icyizere gito', fr: 'Faible confiance' },
  // MFA / Auth
  { key: 'profile.mfa.title', en: 'Two-factor authentication', rw: 'Umutekano wa 2FA', fr: 'Authentification à deux facteurs' },
  { key: 'auth.challenge.backupCode', en: 'Backup code', rw: 'Kode y’inyunganizi', fr: 'Code de secours' },
  { key: 'auth.challenge.authCode', en: 'Authenticator code', rw: 'Kode ya Authenticator', fr: 'Code d’authentification' },
  // Recon
  { key: 'recon.exceptions.title', en: 'Exceptions', rw: 'Ibibazo byabonetse', fr: 'Exceptions' },
  { key: 'recon.bulk.queuedOffline', en: "Queued for sync when you're back online.", rw: 'Bizahuzwa umaze gusubira kuri murandasi.', fr: "Mis en file pour synchronisation dès votre retour en ligne." },
  { key: 'recon.bulk.queuedOnline', en: "Queued for sync when you're online.", rw: 'Bizahuzwa umaze kuboneka ku murandasi.', fr: "Mis en file pour synchronisation lorsque vous êtes en ligne." },
  { key: 'recon.action.queuedOffline', en: "Queued for sync when you're back online.", rw: 'Byateguwe kuzahuzwa umaze gusubira kuri murandasi.', fr: "Mis en file pour synchronisation dès votre retour en ligne." },
  // Auth buttons
  { key: 'auth.buttons.processing', en: 'Processing…', rw: 'Birimo gutunganywa…', fr: 'Traitement…' },
...
for (const rule of expectations) {
  ...
  for (const locale of ['en', 'rw', 'fr']) {
    ...
    if (got[locale] !== expected) {
      bad++;
      console.log(`Inconsistent (${rule.key}) for ${locale}: expected "${expected}", got "${got[locale]}"`);
    }
  }
}
