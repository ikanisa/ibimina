...
**Problem:** `app/build.gradle` was using Java 21 while root `build.gradle` forced Java 17
**Solution:** Changed `app/build.gradle` to use Java 17 consistently
...
**Problem:** Multiple conflicting versions of AndroidX libraries
**Solution:** Updated `variables.gradle` to use compatible versions with Capacitor 7 and SDK 34:
...
**Problem:** Missing force resolutions for transitive dependencies
**Solution:** Updated `build.gradle` resolution strategy:
...
**Solution:** Cleaned build cache: `./gradlew clean`
...
- **Release APK:** `apps/admin/android/app/build/outputs/apk/release/app-release.apk`
...
2. **Java 17:** Stick with Java 17 for Capacitor projects until Java 21 is fully supported
