    ...
    <div className="max-w-4xl mx-auto px-4 space-y-16 pb-16">
      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="glass p-6 space-y-3">
            <Target size={32} className="text-rwyellow" />
          ...
          <div className="glass p-6 space-y-3">
            <TrendingUp size={32} className="text-rwgreen" />
      ...
      <section className="space-y-8">
        ...
        <div className="space-y-4">
          <div className="glass p-6 flex gap-6 items-start">
            <div className="w-16 h-16 bg-rwyellow rounded-full flex items-center justify-center text-ink font-bold flex-shrink-0">
              W1-3
            </div>
            <div className="space-y-2">
              ...
              <div className="text-sm text-rwgreen font-semibold">
          ...
          <div className="glass p-6 flex gap-6 items-start">
            <div className="w-16 h-16 bg-rwblue rounded-full flex items-center justify-center text-ink font-bold flex-shrink-0">
              W4-6
            </div>
            <div className="space-y-2">
          ...
          <div className="glass p-6 flex gap-6 items-start">
            <div className="w-16 h-16 bg-rwgreen rounded-full flex items-center justify-center text-white font-bold flex-shrink-0">
              W7-9
            </div>
            <div className="space-y-2">
          ...
          <div className="glass p-6 flex gap-6 items-start">
            <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center text-ink font-bold flex-shrink-0">
              W10-12
            </div>
            <div className="space-y-2">
      ...
      <section className="glass p-12 text-center space-y-6">
        <Calendar size={48} className="mx-auto text-rwyellow" />
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            href="/contact"
            className="glass px-8 py-4 font-semibold hover:bg-white/20 transition-all"
          >
            Contact Us
          </a>
          <a
