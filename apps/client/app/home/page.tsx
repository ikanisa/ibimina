...
import { mockGroups, mockStatements } from "@/utils/mock";
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xl font-bold text-atlas-blue">
                        {fmtCurrency(group.totalSavings)}
                      </span>
                    </div>
            ...
            <div className="bg-white border border-neutral-200 rounded-2xl overflow-hidden">
              <div className="divide-y divide-neutral-100">
                {recentConfirmations.map((confirmation) => (
                  <div
                    key={confirmation.id}
                    className="p-5 hover:bg-neutral-50 transition-colors duration-interactive"
                  >
