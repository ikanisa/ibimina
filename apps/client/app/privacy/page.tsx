    ...
    <div className="min-h-screen bg-neutral-50 pb-20">
      <header className="bg-white border-b border-neutral-200">
        <div className="mx-auto max-w-screen-xl px-4 py-4">
          ...
          <p className="mt-1 text-sm text-neutral-600">Last updated: October 31, 2025</p>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-3xl space-y-6 px-4 py-6">
        <div className="rounded-2xl border border-neutral-200 bg-white p-6">
          <section className="prose prose-neutral max-w-none">
            ...
            <p className="text-neutral-600">We collect the following information:</p>
            ...
            <h2 className="mt-6 text-xl font-bold text-neutral-900">2. How We Use Your Information</h2>
            <p className="text-neutral-600">Your information is used to:</p>
            <ul className="list-disc pl-6 text-neutral-600">
