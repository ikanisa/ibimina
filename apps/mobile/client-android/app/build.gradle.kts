...
android {
    namespace = "com.ibimina.client"
    compileSdk = 34
    
    defaultConfig {
        applicationId = "com.ibimina.client"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
        ...
        buildConfigField("String", "OPENAI_API_KEY", "\"${properties.getProperty("OPENAI_API_KEY") ?: System.getenv("OPENAI_API_KEY") ?: ""}\"")
        buildConfigField("String", "OPENAI_BASE_URL", "\"${properties.getProperty("OPENAI_BASE_URL") ?: System.getenv("OPENAI_BASE_URL") ?: "https://api.openai.com"}\"")
    }
