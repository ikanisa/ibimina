...
export default function GlobalError({ error, reset }: GlobalErrorProps) {
  console.error("[staff] unhandled app error", error);

  return (
    <html lang="en" className="bg-slate-50">
      <body className="flex min-h-screen flex-col items-center justify-center gap-6 p-6 text-slate-900">
        <div
        ...
        >
          ...
          <p className="mx-auto mb-6 max-w-md text-sm leading-relaxed text-slate-600">
            An unexpected error occurred while loading the Ibimina staff console. Try again. If the
            error continues, contact platform operations with the reference below.
          </p>
          {error.digest && (
