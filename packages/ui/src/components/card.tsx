  ...
  return (
    ...
    >
      <div className="flex-1 space-y-1">
        {title && <h3 className="text-lg font-semibold text-neutral-900 leading-tight">{title}</h3>}
        {description && <p className="text-sm text-neutral-600 leading-normal">{description}</p>}
        {children}
      </div>
...
export const CardContent = forwardRef<HTMLDivElement, CardContentProps>(function CardContent(
  ...
  return <div ref={ref} className={cn("text-neutral-700", className)} {...props} />;
});
