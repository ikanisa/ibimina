...
const colorsHighContrast = {
  ...
  gradients: {
    soft: "linear-gradient(180deg, #ffffff 0%, #e5e5e5 100%)",
    hero: "linear-gradient(180deg, #ffffff 0%, #d9d9d9 100%)",
    mesh: "linear-gradient(135deg, #ffffff 0%, #d1d1d1 100%)",
  },
} as const;
...
const stateHighContrast = {
  focusRing: "rgba(0, 0, 0, 0.9)",
  focusRingOffset: "#ffffff",
...
const shadowsHighContrast = {
  xs: "0 0 0 1px rgba(0, 0, 0, 0.8)",
  sm: "0 2px 0 rgba(0, 0, 0, 0.75)",
  md: "0 4px 0 rgba(0, 0, 0, 0.7)",
  lg: "0 0 0 3px rgba(0, 0, 0, 0.65)",
  xl: "0 0 0 4px rgba(0, 0, 0, 0.6)",
  focus: "0 0 0 3px rgba(0, 0, 0, 0.9)",
} as const;
...
export const designTokens = {
  ...
  "high-contrast": {
    colors: colorsHighContrast,
    state: stateHighContrast,
    spacing: spacingScale,
    radii: radiiScale,
    shadows: shadowsHighContrast,
    typography: typographyTokens,
    motion: motionTokens,
  },
